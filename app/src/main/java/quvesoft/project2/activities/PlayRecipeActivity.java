...
import quvesoft.project2.fragments.PlayRecipeEndFragment;
import quvesoft.project2.fragments.PlayRecipeItemFragment;
import quvesoft.project2.fragments.PlayRecipeStartFragment;
...
public class PlayRecipeActivity extends BaseActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipeItems = new ArrayList<RecipeItem>(Arrays.asList(new RecipeItem[]{
        ...
        for (int i = 0; i < recipeItems.size(); i++) {
            if (i == 0)
                recipeViewPagerAdapter.addFragment(new PlayRecipeStartFragment(), recipeItems.get(i));
            else if (i == recipeItems.size() - 1)
                recipeViewPagerAdapter.addFragment(new PlayRecipeEndFragment(), recipeItems.get(i));
            else
        ...
        podSlider.setNumberOfPods(recipeItems.size());
                ...
                .subscribe(count -> {
                    ...
                    mRecognizer.setRecognitionListener(new RecognitionListener() {
                        ...
                        public void onError(int error) {
                            Project2.getAppInstance().showToast("음성 인식 실패");
                        }
                        ...
                        public void onResults(Bundle results) {
                            ...
                            mResult.toArray(rs);
                            Log.w("dd", rs[0].toString());
                            tts.setText(rs[0].toString());
    ...
    private class RecipeViewPagerAdapter extends FragmentPagerAdapter {
        ...
        private void addFragment(Fragment fragment, RecipeItem item) {
            Bundle b = new Bundle();

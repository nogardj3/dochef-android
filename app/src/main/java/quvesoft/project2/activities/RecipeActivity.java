...
import quvesoft.project2.classes.Review;
    ...
    void setheaderview() {
        try {
            ((ViewPager) findViewById(R.id.recipe_recipeimgs)).setAdapter(new ImagePagerAdapter(RecipeActivity.this,
                    new ArrayList<Integer>(Arrays.asList(new Integer[]{R.drawable.tempimg_playrecipestart, R.drawable.tempimg_playrecipe1, R.drawable.tempimg_playrecipe2, R.drawable.tempimg_playrecipe3, R.drawable.tempimg_playrecipe4, R.drawable.tempimg_playrecipefinish})), Glide.with(this)));

...
import quvesoft.project2.activities.CommentActivity;
import quvesoft.project2.activities.MyHomeActivity;
import quvesoft.project2.activities.PostActivity;
import quvesoft.project2.activities.RevisePostActivity;
import quvesoft.project2.activities.UserHomeActivity;
import quvesoft.project2.classes.Post;
import quvesoft.project2.classes.PostComment;
import quvesoft.project2.utils.BasicCallback;
import quvesoft.project2.views.CustomLoadMoreView;
            ...
            public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                switch (view.getId()) {
                    case R.id.timeline_like:
                        Project2.getAppInstance().showToast("좋아요");
                        break;

                            ...
                            authTask.getResult().getUser().getIdToken(true)
                                    .addOnCompleteListener(task -> {
                                        if (task.isSuccessful()) {
                                            ...
                                            RetrofitServices.SignUpService signUpService = new Retrofit.Builder()
                                            ...
                                            signUpService
                                                    ...
                                                    .enqueue(new BasicCallback<JsonObject>(AccountSigninupActivity.this) {
                                                        @Override
                                                        public void onResponse(Response<JsonObject> response, int err) {
                                                            mProgressDialog.dismiss();
                                                            switch (err) {
                                                                case 814:
                                                                    Intent intent = new Intent(AccountSigninupActivity.this, AccountSigninupNicknameActivity.class)
